 ...
 * возведения числа a в степень b. функция myPrint(a, b, res) – глобальная функция, 
 ...
 * если сеттеру used присвоено значение 'new', при этом год выпуска автомобиля отличается от текущего года,
...
let car2 = {
	...
	get used (){
		if (yearNow - this.year !== 0) { return 'used';
		}
		return 'new';
	},
	set used (value){
